...
- (id)init {
    ...
    if (self) {
        self.topics = [[[NSArray alloc] initWithObjects:
                                            NSLocalizedStringFromTable(@"Question", @"AAMLocalizable", nil),
                                            NSLocalizedStringFromTable(@"Request", @"AAMLocalizable", nil),
                                            NSLocalizedStringFromTable(@"BugReport", @"AAMLocalizable", nil),
                                            NSLocalizedStringFromTable(@"Media", @"AAMLocalizable", nil),
                                            NSLocalizedStringFromTable(@"Business", @"AAMLocalizable", nil),
                                            NSLocalizedStringFromTable(@"Other", @"AAMLocalizable", nil), nil] autorelease];
